  ...
  return (
    <Card>
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <span className="text-right text-sm text-white lg:text-base">{components.no} μg/m3</span>
      </div>
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <span className="text-right text-sm text-white lg:text-base">{components.no2} μg/m3</span>
      </div>
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <span className="text-right text-sm text-white lg:text-base">{components.o3} μg/m3</span>
      </div>
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <span className="text-right text-sm text-white lg:text-base">{components.so2} μg/m3</span>
      </div>
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <span className="text-right text-sm text-white lg:text-base">{components.pm2_5} μg/m3</span>
      </div>
    </Card>
  );
};
