...
export const getLocationLatLonList = async () => {
  try {
    const response = await fetch(`https://lws-eco-vista.vercel.app/api/location`);
    const data = await response.json();
    return data;
  } catch (error) {
    console.error(error);
...
export const getLocationLatLong = async (locationName) => {
  try {
    const response = await fetch(`https://lws-eco-vista.vercel.app/api/location/${locationName}`);
    const data = await response.json();
    return data;
  } catch (e) {
